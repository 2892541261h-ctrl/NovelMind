...
Require-Text "frontend/src/pages/DailyWriterPage.tsx" "/api/daily-writer/generate" "Generate API in DailyWriter"
Require-Text "frontend/src/pages/DailyWriterPage.tsx" "/api/daily-writer/chapters" "Draft API in DailyWriter"
Require-Text "frontend/src/pages/DailyWriterPage.tsx" "/api/formal-chapters/publish-draft/" "Publish API in DailyWriter"
Require-Text "frontend/src/pages/DailyWriterPage.tsx" "/api/chapter-reviews/review-draft/" "Review API in DailyWriter"
