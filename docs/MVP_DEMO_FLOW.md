...
- 切换标签页时旧错误或成功提示会清理
- v1.2 context bar 显示 Story Bible、人物卡、世界观、章节计划、下一章建议和 Continuity 状态

### 6. 填写 Story Bible 长篇资料

进入 `Story Bible`，输入当前 `project_id`。

该看什么：

- 可以维护 Story Bible、人物卡、世界观条目、章节计划、章节摘要和伏笔/线索
- 每个区块都能列表、新增、编辑、删除
- 删除这些长篇资料不会删除草稿或正式章节

讲解重点：

- v1.2 的目标是让 Daily Writer 有长期上下文，而不是只看单章目标。
- 章节摘要和伏笔用于提醒 AI 保持连续性。
...
- Daily Writer 也读取 Story Bible、人物卡、世界观、章节计划、章节摘要和未解决伏笔。
- 生成内容必须服务于用户自己的原创小说。
...
- 可以点击质量检查查看评分、issues、suggestions 和目标达成检查
- 可以点击改写建议；建议不会自动覆盖草稿正文
